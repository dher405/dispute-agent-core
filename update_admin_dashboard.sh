...
echo "[+] Updating Streamlit multi-vertical admin dashboard (app.py)..."
...
echo "[+] Staging app.py and committing changes..."
git add app.py
git commit -m "feat(admin): multi-vertical review queue, webhook telemetry, and dynamic claim tracking" || echo "No changes to commit."
...
echo "================================================================="
echo "   Streamlit Admin Desk Updated & Pushed to Render!              "
echo "   - Portal URL: https://dispute-admin.onrender.com              "
echo "================================================================="
